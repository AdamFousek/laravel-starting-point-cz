...
<template>
    <section>
        <header>
            <h2 class="text-lg font-medium text-gray-900 dark:text-gray-100">{{ $t('profile.updatePassword') }}</h2>
        ...
        <form class="mt-6 space-y-6" @submit.prevent="updatePassword">
            ...
            <div class="flex items-center gap-4">
                ...
                >
                    <p v-if="form.recentlySuccessful" class="text-sm text-gray-600 dark:text-gray-400">{{ $t('profile.saved') }}</p>
                </Transition>
            </div>
        </form>
    </section>
